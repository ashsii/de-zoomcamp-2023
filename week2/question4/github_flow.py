...
github_path = "week2/question4"
python_flow = "etl_web_to_gcs.py"
github_block = GitHub.load("zoom-github")

if __name__ == "__main__":
    # Get data
    github_block.get_directory(from_path=Path('week2/question4'),local_path=Path(script_path))
    ...
    shutil.rmtree(f"{script_path}/week2")
    ...
    deployment = Deployment.build_from_flow(
        ...
        entrypoint="week2/question4/etl_web_to_gcs.py:etl_web_to_gcs")
